...
#define PRODUCT "Az21Encoder" /* 硬件名词，用于蓝牙显示 */
...
static const uint8_t row_pin_array[MATRIX_ROWS] = {10, 7, 6, 12, 19, 99};
static const uint8_t column_pin_array[MATRIX_COLS] = {25, 26, 27, 15, 29, 30, 1, 0, 11, 13, 14, 16, 17, 18, 5};
