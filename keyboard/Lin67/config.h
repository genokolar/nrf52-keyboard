...
#define PRODUCT "Keyboard" /* 硬件名词，用于蓝牙显示 */
...
static const uint8_t row_pin_array[MATRIX_ROWS] = { 28,29,30,27,24 };
static const uint8_t column_pin_array[MATRIX_COLS] = { 19,20,21,26,31,9,3,4,5,6,7,8,16,17,18 };
