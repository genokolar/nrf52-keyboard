...
#define PRODUCT_ID 0x0111 /* USB PID */
#define CONF_VENDOR_ID 0x0601 /* 配置项目内显示的VendorID */
#define CONF_PRODUCT_ID 0x0111 /* 配置项目内显示的ProductID */
#define DEVICE_VER 0x0001 /* 硬件版本 */
#define MANUFACTURER "Lin" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "SUIT 80" /* 硬件名词，用于蓝牙显示 */
...
static const uint8_t row_pin_array[MATRIX_ROWS] = {15,25,26,27,7,0};
static const uint8_t column_pin_array[MATRIX_COLS] = {1,2,3,4,5,31,6,8,9,10,11,12,13,14,22,23,24};
