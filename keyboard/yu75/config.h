...
#define PRODUCT_ID 0x0204 /* USB PID */
#define CONF_VENDOR_ID 0x0601 /* 配置项目内显示的VendorID */
#define CONF_PRODUCT_ID 0x0204 /* 配置项目内显示的ProductID */
#define DEVICE_VER 0x000A /* 硬件版本 */
#define MANUFACTURER "Lin" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "Yu75" /* 硬件名词，用于蓝牙显示 */
...
#define UART_RXD 22 // UART_RX口IO 17
#define UART_TXD 23 // UART_TX口IO 18
...
static const uint8_t row_pin_array[MATRIX_ROWS] = {19,18,20,21,10,24};
static const uint8_t column_pin_array[MATRIX_COLS] = {25,9,31,30,29,28,27,26,11,12,13,14,15,16,17};
