...
/* USB和蓝牙的显示参数 */
#define VENDOR_ID 0x0421 /* USB VID */
#define PRODUCT_ID 0x0314 /* USB PID */
#define CONF_VENDOR_ID 0x4399 /* 配置项目内显示的VendorID */
#define CONF_PRODUCT_ID 0x3366 /* 配置项目内显示的ProductID */
#define DEVICE_VER 0x0000 /* 硬件版本 */
#define MANUFACTURER "Lin" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "Knight101" /* 硬件名词，用于蓝牙显示 */
...
static const uint8_t row_pin_array[MATRIX_ROWS] = {25,26,27,28,18,19};
static const uint8_t column_pin_array[MATRIX_COLS] = {23,22,21,20,29,7,6,8,9,10,11,5,12,13,14,15,4,16,17};
