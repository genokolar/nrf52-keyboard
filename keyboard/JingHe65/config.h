...
#define PRODUCT_ID 0x01A1 /* USB PID */
#define CONF_VENDOR_ID 0x0601 /* 配置项目内显示的VendorID */
#define CONF_PRODUCT_ID 0x01A1 /* 配置项目内显示的ProductID */
#define DEVICE_VER 0x0001 /* 硬件版本 */
#define MANUFACTURER "Lin" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "JingHe65" /* 硬件名词，用于蓝牙显示 */
...
// #define RGB_MATRIX_CENTER { 30,120 }
...
// 电量检测配置
#define BATTERY_ADC_PIN NRF_SAADC_INPUT_AIN4 // 电量检测引脚 Pin 4
...
static const uint8_t row_pin_array[MATRIX_ROWS] = {14,15,16,7,11};
static const uint8_t column_pin_array[MATRIX_COLS] = {25,26,27,6,5,4,31,3,2,10,9,8,18,19,20,21};
