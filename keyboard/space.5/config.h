...
#define PRODUCT_ID 0x0110 /* USB PID */
#define CONF_VENDOR_ID 0x0601 /* 配置项目内显示的VendorID */
#define CONF_PRODUCT_ID 0x0110 /* 配置项目内显示的ProductID */
#define DEVICE_VER 0x0001 /* 硬件版本 */
#define MANUFACTURER "Lin" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "space.5" /* 硬件名词，用于蓝牙显示 */
...
#define UART_RXD 28 // UART_RX口IO 17
...
static const uint8_t row_pin_array[MATRIX_ROWS] = {10,27};
static const uint8_t column_pin_array[MATRIX_COLS] = {26,31,7,13};
