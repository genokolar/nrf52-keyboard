...
/* USB和蓝牙的显示参数 */
#define VENDOR_ID 0x0058 /* USB VID */
#define PRODUCT_ID 0x0042 /* USB PID */
#define CONF_VENDOR_ID 0x0457 /* 配置项目内显示的VendorID */
#define CONF_PRODUCT_ID 0x08AE /* 配置项目内显示的ProductID */
#define DEVICE_VER 0x0000 /* 硬件版本 */
#define MANUFACTURER "Mo" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "Func65" /* 硬件名词，用于蓝牙显示 */
...
static const uint8_t column_pin_array[MATRIX_COLS] = { 21, 22, 23, 24, 25, 20, 19, 18, 17, 16, 15, 14, 13, 11 };
